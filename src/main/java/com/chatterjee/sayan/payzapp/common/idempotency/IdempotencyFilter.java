...
import com.chatterjee.sayan.payzapp.common.exceptions.IdempotencyConflictException;
...
public class IdempotencyFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws ServletException, IOException {
        ...
        if(!claimed){
            // another thread has claimed the key
            ...
            if(existing.isPresent() && !IdempotencyStore.IN_PROGRESS.equals(existing.get())){
                ...
                var ex = new IdempotencyConflictException("A request with the same idempotency key is in progress");
        ...
        try{
            ...
            byte[] bodyBytes = contentCachingResponseWrapper.getContentAsByteArray();
