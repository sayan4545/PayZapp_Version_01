...
@Slf4j
public class InternetBankingPaymentAdapter implements PaymentAdapter {

    private final PaymentProcessorRouter paymentProcessorRouter;
    @Override
    public PaymentResult initiate(PaymentRequest paymentRequest) {
        log.info("Initiating payment with Internet Banking adapter, paymentId : {}",paymentRequest.paymentId());
        try {
            ...
            log.warn("Net Banking failed, paymentId : {}",paymentRequest.paymentId());
