package com.chatterjee.sayan.payzapp.payment.statemachine;
...
import com.chatterjee.sayan.payzapp.common.exceptions.InvalidStateTransitionException;
...
public class PaymentStateMachine {
    /*
    Create a Transition, From current status to destined or target status
     */
